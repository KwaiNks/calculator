...
public class CalculatorTest {
	...
	public void setUp() {
		history = new History();
		memory = new Memory();
		calculator = new Calculator(history, memory);
	}
	...
	@Test
	public void shouldReturnCalculatorHistory() {
		calculator.additionOfTwoNumbers(2.5, 1.3);
		assertEquals(1, calculator.getCalculatorHistory().size());
	}

	@Test
	public void shouldReturnAStoredValueInMemory() {
